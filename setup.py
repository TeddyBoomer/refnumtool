...
setup(
    ...
    description='a module to broadcast news to PPs in EPLE',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/TeddyBoomer/refnumtool',
    ...
    classifiers=[
        ...
        'Intended Audience :: network admin',
        'Topic :: Database',
    ...
    keywords='csv mailing yaml quota',
